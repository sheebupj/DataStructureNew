...
public class AlogorithmTest {
    ...
    public void combinedSortedListTest(){
        ...
        Assertions.assertEquals(expected, CombineListAndSort.getCombinedSortedList(input));
        Assertions.assertEquals(expected2, CombineListAndSort.getCombinedSortedList(input2));
     ...
     */
    @Test
    void getLongestSubStringWithoutDuplicate(){

        Assertions.assertEquals(
                "123", FindLongestSubStringWithoutDuplicate.getLongestSubStringWithoutDuplicate
                        ("12123"));
        Assertions.assertEquals(
                "1234567890", FindLongestSubStringWithoutDuplicate.getLongestSubStringWithoutDuplicate
                        ("12123412345612345671234567891234567890123456789"));
